...
public class ajaxServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String invoiceIdParam = req.getParameter("ID");
        Integer invoiceId = FormatUtils.tryParseInt(invoiceIdParam);
        
        if (invoiceId == null || invoiceDAO.getInvoiceById(invoiceId) == null) {
        ...
        vnp_Params.put("vnp_OrderInfo", "Payment_for: " + invoice.getInvoiceNumber()+ " " + vnp_TxnRef);
