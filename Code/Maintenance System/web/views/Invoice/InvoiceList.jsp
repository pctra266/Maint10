                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>For</th>
                                                <th>Customer</th>
                                                    <c:if test="${staff.hasPermissions('BANK_PAY')||staff.hasPermissions('CONFIRM_PAY_BY_CASH')||staff.hasPermissions('PAY_FOR_OUTSOURCE')}">
                                                    <th>Action</>
                                                    </c:if>
                                            </tr>
                                        </thead>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${invoice.customerID!=null}">
                                                            <td class="d-flex flex-column">
                                                                <c:if test="${staff.hasPermissions('BANK_PAY')}">
                                                                ...
                                                                <c:if test="${staff.hasPermissions('CONFIRM_PAY_BY_CASH')}">
                                                        ...
                                                        <c:otherwise>
                                                            <c:if test="${staff.hasPermissions('PAY_FOR_OUTSOURCE')}">
                                                                <td>
