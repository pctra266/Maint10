...
(5, 6, 'The repair was excellent, and the product works like new.', GETDATE(), 0, NULL, NULL),
...
(5, 6, 'The issue was fixed promptly, and I was kept informed throughout.', GETDATE(), 0, 'https://example.com/images/fixed_issue.jpg', NULL);
