...
VALUES
('cust01', 'T2D6i9+ldWGqevu6W6FAP1iXBbI=', 'John Smith', 'Male', '1990-01-15', 'customer1@example.com', '0123456001', '123 Customer St', 'img/avatars/avatar.jpg'),
('cust02', 'Cw2LaFmhUP2i/jGdPuB5aVCxAQg=', 'Emily Johnson', 'Female', '1992-03-22', 'customer2@example.com', '0123456002', '234 Customer Ave', 'img/avatars/avatar.jpg'),
('cust03', 'G1VKaeAjqcN762tlQAIFfla2Hnc=', 'Michael Brown', 'Male', '1988-07-10', 'customer3@example.com', '0123456003', '345 Customer Blvd', 'img/avatars/avatar.jpg'),
('cust04', 'mnIoccUReEqm3CnIyVEsEqXI418=', 'Sarah Davis', 'Female', '1995-05-30', 'customer4@example.com', '0123456004', '456 Customer Rd', 'img/avatars/avatar.jpg'),
('cust05', 'cDW7EzjR1mP8REo1UF3mWlnuZdo=', 'William Wilson', 'Male', '1987-09-18', 'customer5@example.com', '0123456005', '567 Customer St', 'img/avatars/avatar.jpg'),
('cust06', 'O5eiLfa5pJNrHk7ck1tNBw6pUYE=', 'Olivia Taylor', 'Female', '1993-12-25', 'customer6@example.com', '0123456006', '678 Customer Blvd', 'img/avatars/avatar.jpg'),
('cust07', 't6oNiVU8eL8t1C+e11mByn7n7oA=', 'James Anderson', 'Male', '1989-06-14', 'customer7@example.com', '0123456007', '789 Customer Ave', 'img/avatars/avatar.jpg'),
('cust08', '2L5q1/vlAepSi4mrWEoz+oJnTEY=', 'Sophia Thomas', 'Female', '1997-04-05', 'customer8@example.com', '0123456008', '890 Customer Rd', 'img/avatars/avatar.jpg'),
('cust09', 'hNpyQH84BIbgDRM+z0nJgUqCeV8=', 'Benjamin Moore', 'Male', '1986-08-27', 'customer9@example.com', '0123456009', '123 Customer Blvd', 'img/avatars/avatar.jpg'),
('cust10', 'NiH6AmjlqDCWROFjLhNDiYQ1F5U=', 'Isabella Martin', 'Female', '1991-02-16', 'customer10@example.com', '0123456010', '234 Customer St', 'img/avatars/avatar.jpg'),
('cust11', 'm1HKaKLljc/8wGtZ4IIGTTCCPdE=', 'Jacob Thompson', 'Male', '1984-11-21', 'customer11@example.com', '0123456011', '345 Customer Ave', 'img/avatars/avatar.jpg'),
('cust12', 'z7f1n0HLfbf71/EAPMwcnzUhKLg=', 'Mia Garcia', 'Female', '1996-07-08', 'customer12@example.com', '0123456012', '456 Customer Rd', 'img/avatars/avatar.jpg'),
('cust13', 'hMOqi32PeNalXipffGflzq/L9EY=', 'Daniel Martinez', 'Male', '1985-10-19', 'customer13@example.com', '0123456013', '567 Customer Blvd', 'img/avatars/avatar.jpg'),
('cust14', '6glxG6yT7gkwR4oRHlU7X7akgY4=', 'Charlotte Robinson', 'Female', '1994-09-12', 'customer14@example.com', '0123456014', '678 Customer Ave', 'img/avatars/avatar.jpg'),
('cust15', '01g8MZ8t7IJL2iIGtzRMPTzJiTo=', 'Matthew Clark', 'Male', '1983-03-05', 'customer15@example.com', '0123456015', '789 Customer Rd', 'img/avatars/avatar.jpg'),
('cust16', 'VSoUE0cbBMY/79BqIk1v+kCdG1M=', 'Amelia Rodriguez', 'Female', '1998-06-30', 'customer16@example.com', '0123456016', '890 Customer St', 'img/avatars/avatar.jpg'),
('cust17', 'DTxKhA7pCN1NwkGj1iPWadYUOz0=', 'David Lewis', 'Male', '1982-12-11', 'customer17@example.com', '0123456017', '123 Customer Ave', 'img/avatars/avatar.jpg'),
('cust18', 'R+RhrqNOhedR/3foIWXfAA8DHnc=', 'Abigail Lee', 'Female', '1990-05-09', 'customer18@example.com', '0123456018', '234 Customer Blvd', 'img/avatars/avatar.jpg'),
('cust19', 'nMGd0IHxlcneVgs1GoQ6SjRSB2A=', 'Christopher Walker', 'Male', '1981-07-22', 'customer19@example.com', '0123456019', '345 Customer Rd', 'img/avatars/avatar.jpg'),
('cust20', '8qZHe/AetEyne9jfDSciHoot6Y4=', 'Madison Hall', 'Female', '1999-08-14', 'customer20@example.com', '0123456020', '456 Customer St', 'img/avatars/avatar.jpg');
